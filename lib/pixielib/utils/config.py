...
cfg.model.topology_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "SMPL_X_template_FLAME_uv.obj"
)
cfg.model.topology_smplxtex_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "smplx_tex.obj"
)
cfg.model.topology_smplx_hand_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "smplx_hand.obj"
)
cfg.model.smplx_model_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "SMPLX_NEUTRAL_2020.npz"
)
cfg.model.face_mask_path = os.path.join(cfg.datafile_dir, "HPS/pixie_data", "uv_face_mask.png")
cfg.model.face_eye_mask_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "uv_face_eye_mask.png"
)
cfg.model.tex_path = os.path.join(cfg.datafile_dir, "HPS/pixie_data", "FLAME_albedo_from_BFM.npz")
cfg.model.extra_joint_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "smplx_extra_joints.yaml"
)
cfg.model.j14_regressor_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "SMPLX_to_J14.pkl"
)
cfg.model.flame2smplx_cached_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "flame2smplx_tex_1024.npy"
)
cfg.model.smplx_tex_path = os.path.join(cfg.datafile_dir, "HPS/pixie_data", "smplx_tex.png")
cfg.model.mano_ids_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "MANO_SMPLX_vertex_ids.pkl"
)
cfg.model.flame_ids_path = os.path.join(
    cfg.datafile_dir, "HPS/pixie_data", "SMPL-X__FLAME_vertex_ids.npy"
)
