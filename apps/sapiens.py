...
os.environ["HF_HOME"] = "data/sapiens"
class Config:
    ASSETS_DIR = os.path.join(
        snapshot_download(
            repo_id="facebook/sapiens-normal",
            repo_type="space",
            cache_dir="data/sapiens"
        ),
        'assets'
    )
    CHECKPOINTS_DIR = "data/sapiens/spaces--facebook--sapiens-normal/snapshots/69445cc36a49af657aaa25c86f747c5fc01d3e69/assets/checkpoints/"  # Custom directory for checkpoints
    ...
    SEG_CHECKPOINTS_DIR = "data/sapiens/spaces--facebook--sapiens-normal/snapshots/69445cc36a49af657aaa25c86f747c5fc01d3e69/assets/checkpoints/"  # Custom directory for segmentation models
